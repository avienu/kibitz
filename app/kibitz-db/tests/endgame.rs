...
//!
//! Tablebase-gated tests follow kibitz-tb's own pattern: they skip
...
use kibitz_db::endgame::{self, curriculum, Drill, DrillSession, Goal, Verdict};
use kibitz_tb::{RootProbe, Tablebase, Wdl};
...
fn scripted_kp_win_reaches_mate_without_tablebase() {
    ...
    assert_eq!(kibitz_db::engine::spawn_count(), 0, "engine-off violated");
}
