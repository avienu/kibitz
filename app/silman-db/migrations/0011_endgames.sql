...
-- (app/silman-db/data/endgame_curriculum.json), keyed by stable string ids;
...
CREATE TABLE endgame_attempts (
    ...
    -- detection only; documented in silman_db::endgame).
...
-- consecutive solved attempts; reaching silman_db::endgame::MASTERY_STREAK
