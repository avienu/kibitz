...
## Stage 1 — WSUI tactical screen (silman-core::wsui)
...
## Stage 2 — Imbalance assessment (silman-core::imbalance)
...
## FeatureRecord (silman-core::record) — the universal contract
...
```json
{
  ...
  "provenance": { "generator": "silman-core", "version": "0.1.0" }
}
```
